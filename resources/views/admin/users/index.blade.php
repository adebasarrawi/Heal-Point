...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <form action="{{ route('users.index') }}" method="GET" class="w-75 me-2">
        ...
        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#addUserModal" style="background-color: #e12454; color: white;">
            Add User
        </button>
    </div>
